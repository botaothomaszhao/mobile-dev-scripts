...
1. Install the [Tampermonkey](https://www.tampermonkey.net/) browser extension on your mobile browser (or desktop browser for testing). Some browsers, such as [Via](https://viayoo.com) support userscripts natively without an extension.
